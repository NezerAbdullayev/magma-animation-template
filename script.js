...
document
  ...
  .textContent.split("")
  .forEach((text) => {
    animationH1 += `<span>${text}</span>`;
    document.querySelector("#page2>h1").innerHTML = animationH1;
  });
...
document
  ...
  .textContent.split("")
  .forEach((text) => {
    animationPage4 += `<span>${text}</span>`;
    document.querySelector("#page4>h1").innerHTML = animationPage4;
  });
...
document
  ...
  .textContent.split("")
  .forEach((text) => {
    animationPage6 += `<span>${text}</span>`;
    document.querySelector("#page6>h1").innerHTML = animationPage6;
  });
